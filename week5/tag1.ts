...
const isAvailable2 = (vehicle: scooter | car | bike) => {
    if (vehicle.getTaken()) {
        console.log("Das Fahrzeugmittel ist verfügbar")
    } else {
        console.log("Das Fahrzeugmittel ist vergeben")
    }

    if (vehicle instanceof scooter) {
        if (vehicle.getBatteriePercentage() > 10) {
            console.log("Der Scooter ist verfügbar")
        } else {
            console.log("Der Scooter ist vergeben")
        }

    } else if (vehicle instanceof car) {
        if (vehicle.getFuelPercentage() > 15) {
            console.log("Das Auto ist verfügbar")
        } else {
            console.log("Das Auto ist vergeben")
        }
    }
}
